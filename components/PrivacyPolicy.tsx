  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl md:text-5xl font-extrabold text-brand-dark mb-8">Privacy Policy</h1>
        ...
        <div className="prose prose-lg text-slate-600 max-w-none">
          ...
          <h3 className="text-2xl font-bold text-brand-dark mt-8 mb-4">1. Information We Collect</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-bold text-brand-dark mt-8 mb-4">2. Use of Your Information</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-bold text-brand-dark mt-8 mb-4">3. Disclosure of Your Information</h3>
          <p className="mb-6">
          ...
          <h3 className="text-2xl font-bold text-brand-dark mt-8 mb-4">4. Security of Your Information</h3>
          <p className="mb-6">
            We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.
          </p>

          <h3 className="text-2xl font-bold text-brand-dark mt-8 mb-4">5. Contact Us</h3>
          <p className="mb-6">
