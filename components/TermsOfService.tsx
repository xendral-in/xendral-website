    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg text-slate-300 max-w-none">
          ...
          <h3 className="text-2xl font-bold text-white mt-8 mb-4">1. Use of Services</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-bold text-white mt-8 mb-4">2. Intellectual Property</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-bold text-white mt-8 mb-4">3. User Contributions</h3>
          <p className="mb-6">
          ...
          <h3 className="text-2xl font-bold text-white mt-8 mb-4">4. Limitation of Liability</h3>
          <p className="mb-6">
          ...
          <h3 className="text-2xl font-bold text-white mt-8 mb-4">5. Disclaimer of Warranties</h3>
          <p className="mb-6">
          ...
          <h3 className="text-2xl font-bold text-white mt-8 mb-4">6. Changes to Terms</h3>
          <p className="mb-6">
          ...
          <h3 className="text-2xl font-bold text-white mt-8 mb-4">7. Contact Us</h3>
          <p className="mb-6">
